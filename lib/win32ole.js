...
V8Variant.prototype.vt_name = (function(){
  var names = {};
  var vte = V8Variant.prototype.vt_enum;
...
win32ole.client.Dispatch = function(args){
  var m = require('./metamorphoses');
  return m.metamorphoses(win32ole.Client.prototype.Dispatch.call(this, args));
};
/**/

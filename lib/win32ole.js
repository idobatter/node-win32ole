...
V8Variant.prototype.call = function(){
  ...
  var v = this.OLECall(arguments[0], a);
  if(!V8Variant.prototype.isPrototypeOf(v)) return v;
  return v.vtName() == 'VT_DISPATCH' ? mm.metamorphoses(v) : v;
};

V8Variant.prototype.get = function(methodName, args){
  var a = arguments.length < 2 ? [] : arguments[1];
  var v = this.OLEGet(arguments[0], a);
  if(!V8Variant.prototype.isPrototypeOf(v)) return v;
  return v.vtName() == 'VT_DISPATCH' ? mm.metamorphoses(v) : v;
};
